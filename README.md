...
<h1 align="center" style="text-align:center">ReactPWA - PawJS & Auth</h1>


Example repository for integrating Auth with ReactPWA project. This repo demonstrates the usage & integration of Auth in existing ReactPWA project using React-Cookie.
...
```bash
git clone https://github.com/Atyantik/example-pawjs-auth.git reactpwa-auth && cd reactpwa-auth
```
...
### License
This project is licensed under the MIT license, Copyright (c) 2018 [Atyantik Technologies Private Limited](https://www.atyantik.com). For more information see [LICENSE.md](https://github.com/Atyantik/example-pawjs-auth/blob/master/LICENSE.md).  
